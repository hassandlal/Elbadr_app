...
class BauschCubit extends Cubit<BauschStates> {
  BauschCubit() : super(BauschInitialState());

  static BauschCubit get(context) => BlocProvider.of(context);
  List<ProductModel> bauschProducts = [
