...
class BemlaseCubit extends Cubit<BemlaseStates> {
  BemlaseCubit() : super(BemlaseInitialState());

  static BemlaseCubit get(context) => BlocProvider.of(context);
  List<ProductModel> bemlaseProducts = [
