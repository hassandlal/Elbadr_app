...
import 'package:elbadr_app/modules/tehnodent/cubit/states.dart';
import 'package:flutter_bloc/flutter_bloc.dart';

class TehnodentCubit extends Cubit<TehnodentStates> {
  TehnodentCubit() : super(TehnodentInitialState());

  static TehnodentCubit get(context) => BlocProvider.of(context);
  List<ProductModel> tehnoDentProducts = [
