...
class AmanngirrbachCubit extends Cubit<AmanngirrbachStates> {
  AmanngirrbachCubit() : super(AmanngirrbachInitialState());

  static AmanngirrbachCubit get(context) => BlocProvider.of(context);
  List<ProductModel> amanngirrbachProducts = [
